...
from data_converter import nuscenes_occ_converter_LidarBoxRefactor as occ_converter_lidarbox_refactor
...
def occ_nuscenes_data_prep(root_path,
    ...
    Args:
        ...
        max_sweeps (int): Number of input consecutive frames. Default: 10
    """
    if refactor_lidarbox:
        occ_converter_lidarbox_refactor.create_nuscenes_occ_infos(
...
parser.add_argument('--refactor-lidarbox', help=' ', action='store_true', default=False)
...
if __name__ == '__main__':
    if args.dataset == 'nuscenes' and args.version != 'v1.0-mini':
        ...
        occ_nuscenes_data_prep(
            ...
            out_dir=args.out_dir,
            max_sweeps=args.max_sweeps,
            refactor_lidarbox=args.refactor_lidarbox)
        # test_version = f'{args.version}-test'
        # nuscenes_data_prep(
        #     root_path=args.root_path,
        #     can_bus_root_path=args.canbus,
