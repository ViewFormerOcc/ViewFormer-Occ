...
voxel_vel_path = 'data/nuscenes/occ_flow_sparse_ext'
sparse_vel = True
vel_dim=3
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        with_bev_vel=with_bev_vel,
        align_vel_by_semantic=True,
        ...
        loss_lovasz=dict(
            type='LovaszLoss',
            loss_weight=1.0),
        loss_vel=dict(type='L1Loss', loss_weight=0.25),
        ),
    )
...
train_pipeline = [
    ...
    dict(type='GetVelGTFromBox', voxel_vel_path=voxel_vel_path, sparse_vel=sparse_vel, vel_dim=vel_dim),
...
data = dict(
    ...
    val=dict(
        ...
        queue_length=queue_length,
        video_test_mode=video_test_mode,
        eval_bev_vel=eval_bev_vel,
        voxel_vel_path=voxel_vel_path,
        sparse_vel=sparse_vel,
        vel_dim=vel_dim,
        box_type_3d='LiDAR'),
    test=dict(
